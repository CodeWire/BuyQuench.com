            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="<?php echo base_url(); ?>admin">
                        <img src="<?php echo base_url(); ?>assets/img/quench-admin-logo-wht-m.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
            <!-- end BRAND HEADING -->
                ...
                <ul class="nav navbar-right pull-right">
                   ...
                   <?php /* ?> <li class="dropdown">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo base_url(); ?>assets/img/user-profile-2.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo base_url(); ?>assets/img/user-profile-3.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="row">
                                                <div class="col-xs-2">
                                                    <img class="img-circle" src="<?php echo base_url(); ?>assets/img/user-profile-4.jpg" alt="">
                                                </div>
                                                <div class="col-xs-10">
                                                    <p>
                    ...
                    <?php if(isset($this->session->userdata ["cart_contents"]) && $this->session->userdata["cart_contents"]['customer']){
							...
							$getActiveNoti = $this->Notification_model->getNotification(1,NULL,$customer['id']);
							$getActiveOrderNoti = $this->Notification_model->getNotification(1,'order',$customer['id']);
							$getActiveLeadNoti = $this->Notification_model->getNotification(1,'lead',$customer['id']);
							$totNoti = count($getActiveOrderNoti) + count($getActiveLeadNoti); ?>
                    <li class="dropdown">
                        <a href="#" class="alerts-link dropdown-toggle" data-toggle="dropdown">
                            <i class="fa fa-bell"></i> 
                            <span class="number"><?php echo $totNoti; ?></span><i class="fa fa-caret-down"></i>
                        </a>
                            ...
                            <li class="dropdown-header">
                                <i class="fa fa-bell"></i> <?php echo $totNoti; ?> New Alerts
                            </li>
                            ...
                            <li id="alertScroll">
                                <ul class="list-unstyled">
                                <?php 
								foreach($getActiveOrderNoti as $activeOrderNoti){
									$notidate = new DateTime($activeOrderNoti->date_created);
									//echo 'noti ';var_dump($notidate);
									$today = new DateTime();
									//echo 'today ';var_dump($today);
									$diff = $notidate->diff($today);
									//echo 'diff ';var_dump($diff);
									$hour = $diff->format('%h');
									$min = $diff->format('%i');
									//var_dump($diff); var_dump($hour);
									if($diff->days<1 && $hour<24){
										if($hour>0){
											$postedTime = $hour.' hours ago';
										} else if($min>0){
											$postedTime = $min.' minutes ago';
										} else {
											$postedTime ='Just now';
										}
									} else {
										$year = $notidate->format('Y');
										$month = $notidate->format('m');
										$day = $notidate->format('d');
										$postedTime = $month.'/'.$day.'/'.$year;
									}
									
									echo '<li>
                                        <a target="_blank" class="clearfix" onClick="notificationRead(\''.$activeOrderNoti->id.'\')" href="'.base_url().'admin/sales/sales_list?id='.$activeOrderNoti->id.'">
                                            <div class="alert-icon green pull-left">
                                                <i class="fa fa-money"></i>
                                            </div>'.$activeOrderNoti->title.'
                                ...
                                <?php if(count($getActiveLeadNoti) > 0){
									$leadNotiId = '';
									foreach($getActiveLeadNoti as $getActiveLead){
										$leadNotiId = $getActiveLead->id;?>
                                        <li>
                                        <a  class="clearfix" target="_blank" onClick="notificationRead('<?php echo $leadNotiId; ?>')" href="<?php echo base_url(); ?>admin/leads/leads_list">
                                            <div class="alert-icon blue pull-left">
                                                <i class="fa fa-comment"></i>
                                            </div><?php echo $getActiveLead->title; ?>
                                        </a>
                                    </li>
									<?php } ?>
                                    <?php } ?>
                                    <?php if($totNoti == 0) { ?>
                            <li>New Alerts are not available</li>
                            <?php } ?>
                                    <!--<li>
                                        <a href="#">
                        ...
                        <!--    <li>
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <?php if(isset($totNoti) && $totNoti >0){ ?>
                                    <span class="badge orange"><?php echo $totNoti; ?></span>
                                    <?php } ?>
                                </a>
                            </li>
                      <!--      <li>
...
function notificationRead(notiId){
	$.ajax({
		type: "POST",
		url: "<?php echo base_url('admin/notification/read');?>",
		data: 'noti_id='+notiId,
