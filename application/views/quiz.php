    ...
    <div class="tab-content_no">
                                ...
                                <div class="portlet1 portlet-default1">
                                    <div class="portlet-heading">
                                        ...
                                        <div class="point_arrow"><img src="<?php echo base_url().'assets/img/arrows.png'; ?>" alt=""></div>
                                            <h4 class="start"><a href="javascript:void(0);" class="animated rotateIn" onClick="start(this)">Click here to begin</a></h4>
                                        </div>
